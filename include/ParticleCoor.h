...
#define _PARTICLE_FORMAT_ "mass/F:t:x:y:z:e:px:py:pz:eventweight/D:decayed/I:pid:fatherpid:rootpid:eid:fathereid:eventid/i"

class ParticleCoor {
  public:
    ParticleCoor()
    : mass(0.0), t(0.0), x(0.0), y(0.0), z(0.0), e(0.0), px(0.0), py(0.0), pz(0.0),
      decayed(0), pid(0), fatherpid(0), rootpid(0), eid(0), fathereid(0), eventid(0), eventweight(0)
    { }
    ~ParticleCoor()
    { }
 ...
 * @brief event number
 *
 * @var Double_t ParticleCoor::eventweight
 * @brief event weight from GENBOD
 */
